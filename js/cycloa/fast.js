...
// __rectangle1__ do nothing
	...
	this.run = function () {
		...
		var vramMirroring = this.vramMirroring;
		var pattern = this.pattern;
		var screenBuffer8 = this.screenBuffer8;
		var audioFairy = this.audioFairy;
		var __audio__enabled = audioFairy.enabled;
		var __audio__data = audioFairy.data;
		var __audio__data__length = audioFairy.dataLength;
		var _run = true;
		...
		while (_run) {
			...
			clockDelta = reservedClockDelta;
			reservedClockDelta = 0;
			...
			if (this.NMI) {
				...
				this.P &= 239;
				/* ::CPU::Push */
				ram[0x0100 | (this.SP-- & 0xff)] = (this.PC >> 8) & 0xFF;
				/* ::CPU::Push */
				ram[0x0100 | (this.SP-- & 0xff)] = this.PC & 0xFF;
				/* ::CPU::Push */
				ram[0x0100 | (this.SP-- & 0xff)] = this.P;
				;
				this.P |= 4;
			...
			switch ((pc & 0xE000) >> 13) {
				...
				case 2:
				{ /* 0x4000 -> 0x6000 */
					if (pc === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
						opbyte = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
						this.IRQ &= 254;
						this.IRQ &= 253;
					} else if (pc === 0x4016) {
						opbyte = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
					} else if (pc === 0x4017) {
						opbyte = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
					} else if (addr < 0x4018) {
...
// http://www.llx.com/~nparker/a2/opcodes.html
			switch (inst & 15) {
				...
				{ /* Zeropage */
					...
					switch ((addr_base & 0xE000) >> 13) {
						...
						case 2:
						{ /* 0x4000 -> 0x6000 */
							if (addr_base === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								addr = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr_base === 0x4016) {
								addr = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr_base === 0x4017) {
								addr = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
				...
				{ /* ZeropageX */
					...
					switch ((addr_base & 0xE000) >> 13) {
						...
						{ /* 0x4000 -> 0x6000 */
							if (addr_base === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								addr_base = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr_base === 0x4016) {
								addr_base = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr_base === 0x4017) {
								addr_base = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
								throw new cycloa.err.CoreException('[FIXME] Invalid addr: 0x' + addr_base.toString(16));
							} else {
				...
				{ /* Absolute */
					...
					switch ((addr_base1 & 0xE000) >> 13) {
						...
						case 2:
						{ /* 0x4000 -> 0x6000 */
							if (addr_base1 === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								addr_base1 = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr_base1 === 0x4016) {
								addr_base1 = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr_base1 === 0x4017) {
								addr_base1 = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
					...
					switch ((addr_base2 & 0xE000) >> 13) {
						...
						case 2:
						{ /* 0x4000 -> 0x6000 */
							if (addr_base2 === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								addr_base2 = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr_base2 === 0x4016) {
								addr_base2 = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr_base2 === 0x4017) {
								addr_base2 = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
				...
				{ /* Indirect */
					...
					switch ((addr_base3 & 0xE000) >> 13) {
						...
						case 2:
						{ /* 0x4000 -> 0x6000 */
							if (addr_base3 === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								addr_base4 = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr_base3 === 0x4016) {
								addr_base4 = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr_base3 === 0x4017) {
								addr_base4 = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
					...
					switch ((addr_base5 & 0xE000) >> 13) {
						...
						case 2:
						{ /* 0x4000 -> 0x6000 */
							if (addr_base5 === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								addr_base5 = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr_base5 === 0x4016) {
								addr_base5 = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr_base5 === 0x4017) {
								addr_base5 = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
			...
			switch ((inst & 65520) >> 4) {
				...
				{  /* LDA */
					...
					switch ((addr & 0xE000) >> 13) {
						...
						case 2:
						{ /* 0x4000 -> 0x6000 */
							if (addr === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								tmpA = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr === 0x4016) {
								tmpA = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr === 0x4017) {
								tmpA = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = tmpA];
					break;
				}
				case 1:
				{  /* LDX */
					...
					switch ((addr & 0xE000) >> 13) {
						...
						{ /* 0x4000 -> 0x6000 */
							if (addr === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								tmpX = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr === 0x4016) {
								tmpX = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr === 0x4017) {
								tmpX = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
								throw new cycloa.err.CoreException('[FIXME] Invalid addr: 0x' + addr.toString(16));
							} else {
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.X = tmpX];
					break;
				}
				case 2:
				{  /* LDY */
					...
					switch ((addr & 0xE000) >> 13) {
						...
						{ /* 0x4000 -> 0x6000 */
							if (addr === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								tmpY = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr === 0x4016) {
								tmpY = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr === 0x4017) {
								tmpY = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
								throw new cycloa.err.CoreException('[FIXME] Invalid addr: 0x' + addr.toString(16));
							} else {
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.Y = tmpY];
					break;
				}
				case 3:
				{  /* STA */
					switch ((addr & 0xE000) >> 13) {
						case 0:
						{ /* 0x0000 -> 0x2000 */
							ram[addr & 0x1fff] = this.A;
							break;
						}
						case 1:
						{ /* 0x2000 -> 0x4000 */
							this.writeVideoReg(addr, this.A);
							break;
						}
						case 2:
						{ /* 0x4000 -> 0x6000 */
							switch (addr & 0x1f) {
								...
								{ /* 4002h - APU Frequency Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x0700) | (this.A);
									break;
								}
								case 0x3:
								{ /* 4003h - APU Length Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x00ff) | ((this.A & 7) << 8);
									this.__rectangle0__lengthCounter = this.LengthCounterConst[this.A >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
								...
								{ /* 4006h - APU Frequency Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x0700) | (this.A);
									break;
								}
								case 0x7:
								{ /* 4007h - APU Length Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x00ff) | ((this.A & 7) << 8);
									this.__rectangle1__lengthCounter = this.LengthCounterConst[this.A >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
								...
								{ /* 400Ah - APU Frequency Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x0700) | this.A;
									break;
								}
								case 0xB:
								{ /* 400Bh - APU Length Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x00ff) | ((this.A & 7) << 8);
									this.__triangle__lengthCounter = this.LengthCounterConst[this.A >> 3];
								...
								{ /* 400Fh - APU Length Channel 4 (Noise) */
									...
									this.__noize__lengthCounter = this.LengthCounterConst[this.A >> 3];
									/* and restarts the decay volume (channel 1,2,4 only). */
								...
								{ /* 4011h - DMC Delta counter load register */
									this.__digital__deltaCounter = this.A & 0x7f;
									break;
								}
								case 0x12:
								{ /* 4012h - DMC address load register */
									this.__digital__sampleAddr = 0xc000 | (this.A << 6);
									break;
								}
								case 0x13:
								...
								case 0x14:
								{ /* 4014h execute Sprite DMA */
									/** @type {number} uint16_t */            var addrMask = this.A << 8;
									...
									for (var i = 0; i < 256; ++i) {
										...
										switch ((__addr__ & 0xE000) >> 13) {
											...
											case 2:
											{ /* 0x4000 -> 0x6000 */
												if (__addr__ === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
													__val__ = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
													this.IRQ &= 254;
													this.IRQ &= 253;
												} else if (__addr__ === 0x4016) {
													__val__ = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
												} else if (__addr__ === 0x4017) {
													__val__ = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
												} else if (addr < 0x4018) {
								...
								case 0x15:
								{ /* __audio__analyzeStatusRegister */
									if (!(this.A & 1)) this.__rectangle0__lengthCounter = 0;
								...
								case 0x17:
								{ /* __audio__analyzeLowFrequentryRegister */
								...
								default:
								{            /* this.writeMapperRegisterArea(addr, this.A); */
									break;
								}
							}
							break;
						...
						case 4:
						{ /* 0x8000 -> 0xA000 */
							this.writeMapperCPU(addr, this.A);
							break;
						}
						case 5:
						{ /* 0xA000 -> 0xC000 */
				...
				{  /* STX */
					switch ((addr & 0xE000) >> 13) {
						case 0:
						{ /* 0x0000 -> 0x2000 */
							ram[addr & 0x1fff] = this.X;
							break;
						}
						case 1:
						{ /* 0x2000 -> 0x4000 */
							this.writeVideoReg(addr, this.X);
							break;
						}
						case 2:
						{ /* 0x4000 -> 0x6000 */
							switch (addr & 0x1f) {
								...
								case 0x2:
								{ /* 4002h - APU Frequency Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x0700) | (this.X);
									break;
								}
								case 0x3:
								{ /* 4003h - APU Length Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x00ff) | ((this.X & 7) << 8);
									this.__rectangle0__lengthCounter = this.LengthCounterConst[this.X >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
									this.__rectangle0__dutyCounter = 0;
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__rectangle0__decayReloaded = true;
								...
								case 0x6:
								{ /* 4006h - APU Frequency Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x0700) | (this.X);
									break;
								}
								case 0x7:
								{ /* 4007h - APU Length Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x00ff) | ((this.X & 7) << 8);
									this.__rectangle1__lengthCounter = this.LengthCounterConst[this.X >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
									this.__rectangle1__dutyCounter = 0;
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__rectangle1__decayReloaded = true;
								...
								case 0xA:
								{ /* 400Ah - APU Frequency Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x0700) | this.X;
									break;
								}
								case 0xB:
								{ /* 400Bh - APU Length Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x00ff) | ((this.X & 7) << 8);
									this.__triangle__lengthCounter = this.LengthCounterConst[this.X >> 3];
									/* Side effects 	Sets the halt flag */
									this.__triangle__haltFlag = true;
									break;
								}
								...
								{ /* 400Fh - APU Length Channel 4 (Noise) */
									/* Writing to the length registers restarts the length (obviously), */
									this.__noize__lengthCounter = this.LengthCounterConst[this.X >> 3];
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__noize__decayReloaded = true;
									break;
								}        /* ------------------------------------ DMC ----------------------------------------------------- */
								...
								case 0x11:
								{ /* 4011h - DMC Delta counter load register */
									this.__digital__deltaCounter = this.X & 0x7f;
									break;
								}
								case 0x12:
								{ /* 4012h - DMC address load register */
									this.__digital__sampleAddr = 0xc000 | (this.X << 6);
									break;
								}
								case 0x13:
								{ /* 4013h - DMC length register */
								...
								case 0x14:
								{ /* 4014h execute Sprite DMA */
									/** @type {number} uint16_t */            var addrMask = this.X << 8;
									var spRam = this.spRam;
									var spriteAddr = this.spriteAddr;
									for (var i = 0; i < 256; ++i) {
										var __addr__ = addrMask | i;
								...
								case 0x15:
								{ /* __audio__analyzeStatusRegister */
									if (!(this.X & 1)) this.__rectangle0__lengthCounter = 0;
								...
								default:
								{            /* this.writeMapperRegisterArea(addr, this.X); */
									break;
								}
							}
							break;
						...
						case 4:
						{ /* 0x8000 -> 0xA000 */
							this.writeMapperCPU(addr, this.X);
							break;
						}
						case 5:
						{ /* 0xA000 -> 0xC000 */
				...
				{  /* STY */
					switch ((addr & 0xE000) >> 13) {
						case 0:
						{ /* 0x0000 -> 0x2000 */
							ram[addr & 0x1fff] = this.Y;
							break;
						}
						case 1:
						{ /* 0x2000 -> 0x4000 */
							this.writeVideoReg(addr, this.Y);
							break;
						}
						case 2:
						{ /* 0x4000 -> 0x6000 */
							switch (addr & 0x1f) {
								...
								case 0x2:
								{ /* 4002h - APU Frequency Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x0700) | (this.Y);
									break;
								}
								case 0x3:
								{ /* 4003h - APU Length Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x00ff) | ((this.Y & 7) << 8);
									this.__rectangle0__lengthCounter = this.LengthCounterConst[this.Y >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
									this.__rectangle0__dutyCounter = 0;
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__rectangle0__decayReloaded = true;
								...
								case 0x6:
								{ /* 4006h - APU Frequency Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x0700) | (this.Y);
									break;
								}
								case 0x7:
								{ /* 4007h - APU Length Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x00ff) | ((this.Y & 7) << 8);
									this.__rectangle1__lengthCounter = this.LengthCounterConst[this.Y >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
									this.__rectangle1__dutyCounter = 0;
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__rectangle1__decayReloaded = true;
								...
								case 0xA:
								{ /* 400Ah - APU Frequency Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x0700) | this.Y;
									break;
								}
								case 0xB:
								{ /* 400Bh - APU Length Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x00ff) | ((this.Y & 7) << 8);
									this.__triangle__lengthCounter = this.LengthCounterConst[this.Y >> 3];
									/* Side effects 	Sets the halt flag */
									this.__triangle__haltFlag = true;
									break;
								}
								...
								{ /* 400Fh - APU Length Channel 4 (Noise) */
									/* Writing to the length registers restarts the length (obviously), */
									this.__noize__lengthCounter = this.LengthCounterConst[this.Y >> 3];
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__noize__decayReloaded = true;
									break;
								}        /* ------------------------------------ DMC ----------------------------------------------------- */
								...
								case 0x11:
								{ /* 4011h - DMC Delta counter load register */
									this.__digital__deltaCounter = this.Y & 0x7f;
									break;
								}
								case 0x12:
								{ /* 4012h - DMC address load register */
									this.__digital__sampleAddr = 0xc000 | (this.Y << 6);
									break;
								}
								case 0x13:
								{ /* 4013h - DMC length register */
								...
								case 0x14:
								{ /* 4014h execute Sprite DMA */
									/** @type {number} uint16_t */            var addrMask = this.Y << 8;
									var spRam = this.spRam;
									var spriteAddr = this.spriteAddr;
									for (var i = 0; i < 256; ++i) {
										var __addr__ = addrMask | i;
								...
								case 0x15:
								{ /* __audio__analyzeStatusRegister */
									if (!(this.Y & 1)) this.__rectangle0__lengthCounter = 0;
								...
								default:
								{            /* this.writeMapperRegisterArea(addr, this.Y); */
									break;
								}
							}
							break;
						...
						case 4:
						{ /* 0x8000 -> 0xA000 */
							this.writeMapperCPU(addr, this.Y);
							break;
						}
						case 5:
						{ /* 0xA000 -> 0xC000 */
				...
				{  /* TAX */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.X = this.A];
					break;
				}
				case 7:
				{  /* TAY */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.Y = this.A];
					break;
				}
				case 8:
				{  /* TSX */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.X = this.SP];
					break;
				}
				case 9:
				{  /* TXA */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = this.X];
					break;
				}
				case 10:
				{  /* TXS */
				...
				{  /* TYA */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = this.Y];
					break;
				}
				case 12:
				{  /* ADC */
					...
					switch ((addr & 0xE000) >> 13) {
						...
						{ /* 0x4000 -> 0x6000 */
							if (addr === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								val = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr === 0x4016) {
								val = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr === 0x4017) {
								val = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
								throw new cycloa.err.CoreException('[FIXME] Invalid addr: 0x' + addr.toString(16));
							} else {
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = newA];
					break;
				}
				case 13:
				{  /* AND */
					...
					switch ((addr & 0xE000) >> 13) {
						...
						{ /* 0x4000 -> 0x6000 */
							if (addr === 0x4015) {             /* Clears the frame interrupt flag after being read (but not the DMC interrupt flag).			   If an interrupt flag was set at the same moment of the read, it will read back as 1 but it will not be cleared. */
								mem = ( (this.__rectangle0__lengthCounter != 0 && this.__rectangle0__frequency >= 0x8 && this.__rectangle0__frequency < 0x800) ? 1 : 0) | ((this.__rectangle1__lengthCounter != 0 && this.__rectangle1__frequency >= 0x8 && this.__rectangle1__frequency < 0x800) ? 2 : 0) | ((this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) ? 4 : 0) | ((this.__noize__lengthCounter != 0) ? 8 : 0) | ((this.__digital__sampleLength != 0) ? 16 : 0) | (((this.IRQ & 1)) ? 64 : 0) | ((this.IRQ & 2) ? 128 : 0);
								this.IRQ &= 254;
								this.IRQ &= 253;
							} else if (addr === 0x4016) {
								mem = this.pad1Fairy.isPressed((this.pad1Idx++) & 7) ? 1 : 0;
							} else if (addr === 0x4017) {
								mem = this.pad2Fairy.isPressed((this.pad2Idx++) & 7) ? 1 : 0;
							} else if (addr < 0x4018) {
								throw new cycloa.err.CoreException('[FIXME] Invalid addr: 0x' + addr.toString(16));
							} else {
					...
					;
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A &= mem];
					break;
				}
				case 14:
				{  /* ASL */
					...
					switch ((addr & 0xE000) >> 13) {
						case 0:
						{ /* 0x0000 -> 0x2000 */
							ram[addr & 0x1fff] = shifted;
							break;
						}
						case 1:
						{ /* 0x2000 -> 0x4000 */
							this.writeVideoReg(addr, shifted);
							break;
						}
						case 2:
						{ /* 0x4000 -> 0x6000 */
							switch (addr & 0x1f) {
								case 0x0:
								{ /* 4000h - APU Volume/Decay Channel 1 (Rectangle) */
									this.__rectangle0__decayCounter = this.__rectangle0__volumeOrDecayRate = shifted & 15;
								...
								case 0x1:
								{ /* 4001h - APU Sweep Channel 1 (Rectangle) */
									this.__rectangle0__sweepShiftAmount = shifted & 7;
									this.__rectangle0__sweepIncreased = (shifted & 0x8) === 0x0;
									this.__rectangle0__sweepCounter = this.__rectangle0__sweepUpdateRatio = (shifted >> 4) & 3;
									this.__rectangle0__sweepEnabled = (shifted & 0x80) === 0x80;
									break;
								}
								case 0x2:
								{ /* 4002h - APU Frequency Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x0700) | (shifted);
									break;
								}
								case 0x3:
								{ /* 4003h - APU Length Channel 1 (Rectangle) */
									this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x00ff) | ((shifted & 7) << 8);
									this.__rectangle0__lengthCounter = this.LengthCounterConst[shifted >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
									this.__rectangle0__dutyCounter = 0;
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__rectangle0__decayReloaded = true;
								...
								case 0x4:
								{ /* 4004h - APU Volume/Decay Channel 2 (Rectangle) */
									this.__rectangle1__decayCounter = this.__rectangle1__volumeOrDecayRate = shifted & 15;
								...
								case 0x5:
								{ /* 4005h - APU Sweep Channel 2 (Rectangle) */
									this.__rectangle1__sweepShiftAmount = shifted & 7;
									this.__rectangle1__sweepIncreased = (shifted & 0x8) === 0x0;
									this.__rectangle1__sweepCounter = this.__rectangle1__sweepUpdateRatio = (shifted >> 4) & 3;
									this.__rectangle1__sweepEnabled = (shifted & 0x80) === 0x80;
									break;
								}
								case 0x6:
								{ /* 4006h - APU Frequency Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x0700) | (shifted);
									break;
								}
								case 0x7:
								{ /* 4007h - APU Length Channel 2 (Rectangle) */
									this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x00ff) | ((shifted & 7) << 8);
									this.__rectangle1__lengthCounter = this.LengthCounterConst[shifted >> 3];
									/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
									this.__rectangle1__dutyCounter = 0;
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__rectangle1__decayReloaded = true;
								...
								case 0x8:
								{ /* 4008h - APU Linear Counter Channel 3 (Triangle) */
									this.__triangle__enableLinearCounter = ((shifted & 128) == 128);
								...
								case 0xA:
								{ /* 400Ah - APU Frequency Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x0700) | shifted;
									break;
								}
								case 0xB:
								{ /* 400Bh - APU Length Channel 3 (Triangle) */
									this.__triangle__frequency = (this.__triangle__frequency & 0x00ff) | ((shifted & 7) << 8);
									this.__triangle__lengthCounter = this.LengthCounterConst[shifted >> 3];
									/* Side effects 	Sets the halt flag */
									this.__triangle__haltFlag = true;
									break;
								}
								case 0xC:
								{ /* 400Ch - APU Volume/Decay Channel 4 (Noise) */
									this.__noize__decayCounter = this.__noize__volumeOrDecayRate = shifted & 15;
								...
								case 0xe:
								{ /* 400Eh - APU Frequency Channel 4 (Noise) */
									this.__noize__modeFlag = (shifted & 128) == 128;
								...
								{ /* 400Fh - APU Length Channel 4 (Noise) */
									/* Writing to the length registers restarts the length (obviously), */
									this.__noize__lengthCounter = this.LengthCounterConst[shifted >> 3];
									/* and restarts the decay volume (channel 1,2,4 only). */
									this.__noize__decayReloaded = true;
									break;
								}        /* ------------------------------------ DMC ----------------------------------------------------- */
								case 0x10:
								{ /* 4010h - DMC Play mode and DMA frequency */
									this.__digital__irqEnabled = (shifted & 128) == 128;
									if (!this.__digital__irqEnabled) {
										this.IRQ &= 253;
									}
								...
								case 0x11:
								{ /* 4011h - DMC Delta counter load register */
									this.__digital__deltaCounter = shifted & 0x7f;
									break;
								}
								case 0x12:
								{ /* 4012h - DMC address load register */
									this.__digital__sampleAddr = 0xc000 | (shifted << 6);
									break;
								}
								case 0x13:
								{ /* 4013h - DMC length register */
									this.__digital__sampleLength = this.__digital__sampleLengthBuffer = (shifted << 4) | 1;
									break;
								}
								case 0x14:
								{ /* 4014h execute Sprite DMA */
									/** @type {number} uint16_t */            var addrMask = shifted << 8;
									var spRam = this.spRam;
									var spriteAddr = this.spriteAddr;
									for (var i = 0; i < 256; ++i) {
										var __addr__ = addrMask | i;
								...
								case 0x15:
								{ /* __audio__analyzeStatusRegister */
									if (!(shifted & 1)) this.__rectangle0__lengthCounter = 0;
								...
								default:
								{            /* this.writeMapperRegisterArea(addr, shifted); */
									break;
								}
							}
							break;
						...
						case 4:
						{ /* 0x8000 -> 0xA000 */
							this.writeMapperCPU(addr, shifted);
							break;
						}
						case 5:
						{ /* 0xA000 -> 0xC000 */
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[shifted & 0xff];
					break;
				}
				case 15:
				{  /* ASL_ */
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = (a << 1) & 0xff];
					break;
				}
				case 16:
				{  /* BIT */
				...
				{  /* CMP */
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[val & 0xff];
				...
				{  /* DEC */
					...
					var val = (mem - 1) & 0xff;
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[val];
					switch ((addr & 0xE000) >> 13) {
						case 0:
						{ /* 0x0000 -> 0x2000 */
							ram[addr & 0x1fff] = val;
						...
						{ /* 0x4000 -> 0x6000 */
							switch (addr & 0x1f) {
								...
								case 0x14:
								{ /* 4014h execute Sprite DMA */
									/** @type {number} uint16_t */            var addrMask = val << 8;
									var spRam = this.spRam;
									var spriteAddr = this.spriteAddr;
									for (var i = 0; i < 256; ++i) {
										var __addr__ = addrMask | i;
				...
				{  /* DEX */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.X = (this.X - 1) & 0xff];
					break;
				}
				case 22:
				{  /* DEY */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.Y = (this.Y - 1) & 0xff];
					break;
				}
				case 23:
				{  /* EOR */
				...
				{  /* LSR */
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[shifted];
					break;
				}
				case 28:
				{  /* LSR_ */
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A >>= 1];
					break;
				}
				case 29:
				{  /* ORA */
				...
				{  /* ROL_ */
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = (a << 1) | (p & 0x01)];
					break;
				}
				case 32:
				{  /* ROR */
				...
				{  /* ROR_ */
					...
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = ((a >> 1) & 0x7f) | ((p & 0x1) << 7)];
					break;
				}
				case 34:
				{  /* SBC */
				...
				{  /* PHA */
					/* ::CPU::Push */
					ram[0x0100 | (this.SP-- & 0xff)] = this.A;
					break;
				}
				case 36:
				{  /* PHP */
					...
					/* ::CPU::Push */
					ram[0x0100 | (this.SP-- & 0xff)] = this.P | 0x10;
					break;
				}
				case 37:
				{  /* PLA */
					/* UpdateFlag */
					this.P = (this.P & 0x7D) | this.ZNFlagCache[this.A = /* ::CPU::Pop */ (ram[0x0100 | (++this.SP & 0xff)])];
					break;
				}
				case 38:
				{  /* PLP */
				...
				{  /* JSR */
					...
					/* ::CPU::Push */
					ram[0x0100 | (this.SP-- & 0xff)] = ((stored_pc >> 8) & 0xFF);
					/* ::CPU::Push */
					ram[0x0100 | (this.SP-- & 0xff)] = (stored_pc & 0xFF);
					this.PC = addr;
					break;
				}
				case 52:
			...
			while (this.nowX >= 341) {
				...
				if (nowY <= 240) {
					...
					this.NMI = this.executeNMIonVBlank;
					/* reserve NMI if emabled */
					this.onVBlank();
				} else if (nowY <= 261) {
					//nowVBlank.
				} else if (nowY === 262) {
			...
			while (this.__audio__clockCnt >= 1786840) {
				/*unsigned int*/
				var processClock = 1786840 + this.__audio__leftClock;
				/*unsigned int*/
				var delta = (processClock / 22050) | 0;
				...
				if (this.__triangle__lengthCounter != 0 && this.__triangle__linearCounter != 0) {
					...
					/* unsigned int */
					var nowCounter = this.__triangle__freqCounter + delta;
				...
				if (this.__noize__lengthCounter != 0) {
					/* unsigned int */
					var nowCounter = this.__noize__freqCounter + delta;
					/* const uint16_t */
					var divFreq = this.__noize__frequency + 1;
					/* const uint8_t */
					var shiftAmount = this.__noize__modeFlag ? 6 : 1;
				...
				if (this.__digital__sampleLength != 0) {
					/*unsigned int*/
					var nowCounter = this.__digital__freqCounter + delta;
					/*const uint16_t*/
					var divFreq = this.__digital__frequency + 1;
					while (nowCounter >= divFreq) {
						nowCounter -= divFreq;
	...
	this.onHardResetCPU = function () {
		...
		switch ((0x4017 & 0xE000) >> 13) {
			case 0:
			{ /* 0x0000 -> 0x2000 */
				ram[0x4017 & 0x1fff] = 0x00;
				break;
			}
			case 1:
			{ /* 0x2000 -> 0x4000 */
				this.writeVideoReg(0x4017, 0x00);
				break;
			}
			case 2:
			{ /* 0x4000 -> 0x6000 */
				switch (0x4017 & 0x1f) {
					case 0x0:
					{ /* 4000h - APU Volume/Decay Channel 1 (Rectangle) */
						this.__rectangle0__decayCounter = this.__rectangle0__volumeOrDecayRate = 0x00 & 15;
					...
					case 0x1:
					{ /* 4001h - APU Sweep Channel 1 (Rectangle) */
						this.__rectangle0__sweepShiftAmount = 0x00 & 7;
					...
					case 0x2:
					{ /* 4002h - APU Frequency Channel 1 (Rectangle) */
						this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x0700) | (0x00);
						break;
					}
					case 0x3:
					{ /* 4003h - APU Length Channel 1 (Rectangle) */
						this.__rectangle0__frequency = (this.__rectangle0__frequency & 0x00ff) | ((0x00 & 7) << 8);
						this.__rectangle0__lengthCounter = this.LengthCounterConst[0x00 >> 3];
						/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
						this.__rectangle0__dutyCounter = 0;
						/* and restarts the decay volume (channel 1,2,4 only). */
						this.__rectangle0__decayReloaded = true;
					...
					case 0x4:
					{ /* 4004h - APU Volume/Decay Channel 2 (Rectangle) */
						this.__rectangle1__decayCounter = this.__rectangle1__volumeOrDecayRate = 0x00 & 15;
					...
					case 0x5:
					{ /* 4005h - APU Sweep Channel 2 (Rectangle) */
						this.__rectangle1__sweepShiftAmount = 0x00 & 7;
					...
					case 0x6:
					{ /* 4006h - APU Frequency Channel 2 (Rectangle) */
						this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x0700) | (0x00);
						break;
					}
					case 0x7:
					{ /* 4007h - APU Length Channel 2 (Rectangle) */
						this.__rectangle1__frequency = (this.__rectangle1__frequency & 0x00ff) | ((0x00 & 7) << 8);
						this.__rectangle1__lengthCounter = this.LengthCounterConst[0x00 >> 3];
						/* Writing to the length registers restarts the length (obviously),			and also restarts the duty cycle (channel 1,2 only), */
						this.__rectangle1__dutyCounter = 0;
						/* and restarts the decay volume (channel 1,2,4 only). */
						this.__rectangle1__decayReloaded = true;
					...
					case 0x8:
					{ /* 4008h - APU Linear Counter Channel 3 (Triangle) */
						this.__triangle__enableLinearCounter = ((0x00 & 128) == 128);
					...
					case 0xA:
					{ /* 400Ah - APU Frequency Channel 3 (Triangle) */
						this.__triangle__frequency = (this.__triangle__frequency & 0x0700) | 0x00;
						break;
					}
					case 0xB:
					{ /* 400Bh - APU Length Channel 3 (Triangle) */
						this.__triangle__frequency = (this.__triangle__frequency & 0x00ff) | ((0x00 & 7) << 8);
						this.__triangle__lengthCounter = this.LengthCounterConst[0x00 >> 3];
						/* Side effects 	Sets the halt flag */
						this.__triangle__haltFlag = true;
						break;
					}
					case 0xC:
					{ /* 400Ch - APU Volume/Decay Channel 4 (Noise) */
						this.__noize__decayCounter = this.__noize__volumeOrDecayRate = 0x00 & 15;
					...
					case 0xe:
					{ /* 400Eh - APU Frequency Channel 4 (Noise) */
						this.__noize__modeFlag = (0x00 & 128) == 128;
					...
					{ /* 400Fh - APU Length Channel 4 (Noise) */
						/* Writing to the length registers restarts the length (obviously), */
						this.__noize__lengthCounter = this.LengthCounterConst[0x00 >> 3];
						/* and restarts the decay volume (channel 1,2,4 only). */
						this.__noize__decayReloaded = true;
						break;
					}        /* ------------------------------------ DMC ----------------------------------------------------- */
					case 0x10:
					{ /* 4010h - DMC Play mode and DMA frequency */
						this.__digital__irqEnabled = (0x00 & 128) == 128;
						if (!this.__digital__irqEnabled) {
							this.IRQ &= 253;
						}
					...
					case 0x11:
					{ /* 4011h - DMC Delta counter load register */
						this.__digital__deltaCounter = 0x00 & 0x7f;
						break;
					}
					case 0x12:
					{ /* 4012h - DMC address load register */
						this.__digital__sampleAddr = 0xc000 | (0x00 << 6);
						break;
					}
					case 0x13:
					{ /* 4013h - DMC length register */
						this.__digital__sampleLength = this.__digital__sampleLengthBuffer = (0x00 << 4) | 1;
						break;
					}
					case 0x14:
					{ /* 4014h execute Sprite DMA */
						/** @type {number} uint16_t */            var addrMask = 0x00 << 8;
						var spRam = this.spRam;
						var spriteAddr = this.spriteAddr;
						for (var i = 0; i < 256; ++i) {
							var __addr__ = addrMask | i;
					...
					case 0x15:
					{ /* __audio__analyzeStatusRegister */
						if (!(0x00 & 1)) this.__rectangle0__lengthCounter = 0;
					...
					default:
					{            /* this.writeMapperRegisterArea(0x4017, 0x00); */
						break;
					}
				}
				break;
			...
			case 4:
			{ /* 0x8000 -> 0xA000 */
				this.writeMapperCPU(0x4017, 0x00);
				break;
			}
			case 5:
			{ /* 0xA000 -> 0xC000 */
		...
		switch ((0x4015 & 0xE000) >> 13) {
			case 0:
			{ /* 0x0000 -> 0x2000 */
				ram[0x4015 & 0x1fff] = 0x00;
				break;
			}
			case 1:
			{ /* 0x2000 -> 0x4000 */
				this.writeVideoReg(0x4015, 0x00);
				break;
			}
			case 2:
			{ /* 0x4000 -> 0x6000 */
				switch (0x4015 & 0x1f) {
					...
					default:
					{            /* this.writeMapperRegisterArea(0x4015, 0x00); */
						break;
					}
				}
				break;
			...
			case 4:
			{ /* 0x8000 -> 0xA000 */
				this.writeMapperCPU(0x4015, 0x00);
				break;
			}
			case 5:
			{ /* 0xA000 -> 0xC000 */
